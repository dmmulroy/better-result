...
export class Ok<A, E = never> {
   ...
   */
  tryRecover<U, E2>(_fn: (e: never) => Result<U, E2>): Ok<A | U, E2> {
    // SAFETY: E is phantom on Ok (not used at runtime), and A⊂(A|U).
    return this as unknown as Ok<A | U, E2>;
  }
   ...
   */
  tryRecoverAsync<U, E2>(_fn: (e: never) => Promise<Result<U, E2>>): Promise<Ok<A | U, E2>> {
    // SAFETY: E is phantom on Ok (not used at runtime), and A⊂(A|U).
    return Promise.resolve(this as unknown as Ok<A | U, E2>);
  }
...
export class Err<T, E> {
   ...
   */
  tryRecover<U, E2>(fn: (e: E) => Result<U, E2>): Result<T | U, E2> {
   ...
   */
  tryRecoverAsync<U, E2>(fn: (e: E) => Promise<Result<U, E2>>): Promise<Result<T | U, E2>> {
...
const tryRecover: {
  <A, U, E, E2>(result: Result<A, E>, fn: (e: E) => Result<U, E2>): Result<A | U, E2>;
  <E, U, E2>(fn: (e: E) => Result<U, E2>): <A>(result: Result<A, E>) => Result<A | U, E2>;
} = dual(2, <A, U, E, E2>(result: Result<A, E>, fn: (e: E) => Result<U, E2>): Result<A | U, E2> => {
...
const tryRecoverAsync: {
  <A, U, E, E2>(
    result: Result<A, E>,
    fn: (e: E) => Promise<Result<U, E2>>,
  ): Promise<Result<A | U, E2>>;
  <E, U, E2>(
    fn: (e: E) => Promise<Result<U, E2>>,
  ): <A>(result: Result<A, E>) => Promise<Result<A | U, E2>>;
} = dual(
  2,
  <A, U, E, E2>(
    result: Result<A, E>,
